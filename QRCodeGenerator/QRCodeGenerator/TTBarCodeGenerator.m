...
@implementation TTBarCodeGenerator
...
+ (UIImage *)generateBarCodeWithString:(NSString *)string
{
    ...
    {
        return [[RSUnifiedCodeGenerator codeGen]
                genCodeWithContents:string machineReadableCodeObjectType:AVMetadataObjectTypeCode128Code];
    }
